...
# Configuration Script – LT4 - Rev. A

This **Configuration** script is designed for the **LT4** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – LT4 Rev. A

Este script de **Configuration** está diseñado para el modelo **LT4** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
